...
func (_q *ServerQuery) FirstID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *ServerQuery) FirstIDX(ctx context.Context) uint32 {
...
func (_q *ServerQuery) OnlyID(ctx context.Context) (id uint32, err error) {
	var ids []uint32
...
func (_q *ServerQuery) OnlyIDX(ctx context.Context) uint32 {
...
func (_q *ServerQuery) IDs(ctx context.Context) (ids []uint32, err error) {
...
func (_q *ServerQuery) IDsX(ctx context.Context) []uint32 {
	ids, err := _q.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (_q *ServerQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(server.Table, server.Columns, sqlgraph.NewFieldSpec(server.FieldID, field.TypeUint32))
	_spec.From = _q.sql
...
func (_q *ServerQuery) ForUpdate(opts ...sql.LockOption) *ServerQuery {
...
func (_q *ServerQuery) ForShare(opts ...sql.LockOption) *ServerQuery {
	if _q.driver.Dialect() == dialect.Postgres {
		_q.Unique(false)
	}
	_q.modifiers = append(_q.modifiers, func(s *sql.Selector) {
