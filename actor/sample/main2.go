...
//	// rs := base.GetRsClient("binance_usdt_swap", helper.BrokerConfig{
//	rs := binance_usdt_swap.NewRs(&helper.BrokerConfig{
//		Name:      helper.BrokernameBinanceUsdSwap.String(),
//		AccessKey: "xUQf3pCiGRJQlgrTiXw97HLr9C1zvW1bTlVWchfXPcdSTPmpiiqq3wYfs2anMQlm",
//		SecretKey: "viO1Lw3l6FVEPdBq2CC6M30WQs1AlqYVdaXYmqhFprw4mErzv3650DPQ6zzlaFIP",
//		PassKey:   "",
...
//		&rsPairInfo,
//		refRsCb)
//	rs.BeforeTrade(helper.HandleModeCloseOne)
//	{
//		tradeMsg := helper.TradeMsg{}
//		refWsCb := helper.CallbackFunc{
//			OnTicker: func(ts int64) {
//				if ts%16 == 0 {
//					log.Warnf("ts costed at onTicker before[%d]: %d", ts, time.Now().UnixNano()-ts)
//				}
//				rs.SendSignal([]helper.Signal{{
//					Type:      helper.SignalTypeNewOrder,
//					ClientID:  strconv.FormatInt(time.Now().UnixNano(), 10),
//					Price:     tradeMsg.RecvTicker.Mp.Load() * (1 - 0.05),
//					Amount:    fixed.ONE,
//					Time:      ts,
...
//				})
//				if ts%16 == 0 {
//					log.Warnf("ts costed at onTicker after[%d]: %d", ts, time.Now().UnixNano()-ts)
//					_, _, t2t := rs.GetDelay()
//					log.Warnf("t2t avg[%d]: %d", ts, t2t)
//				}
//			},
//			OnEquity:   func(ts int64) {},
//			OnPosition: func(ts int64) {},
...
//		// ws := base.GetWsClient("binance_usdt_swap", helper.BrokerConfig{
//		ws := binance_usdt_swap.NewWs(&helper.BrokerConfig{
//			Name:       helper.BrokernameBinanceUsdSwap.String(),
//			AccessKey:  "xUQf3pCiGRJQlgrTiXw97HLr9C1zvW1bTlVWchfXPcdSTPmpiiqq3wYfs2anMQlm",
//			SecretKey:  "viO1Lw3l6FVEPdBq2CC6M30WQs1AlqYVdaXYmqhFprw4mErzv3650DPQ6zzlaFIP",
//			PassKey:    "",
...
//	}()
//	<-ch
//	rs.AfterTrade(helper.HandleModeCloseOne)
//}
//
////// 入口函数
////func main() {
